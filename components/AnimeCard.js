...
function AnimeCard({ imgUrl, name, rating, animeID, type, totalEpisodes, mobile=false }){
    ...
    return (
        <Box key={name} transform="scale(1)" onClick={clicked} className={animeID} id="animeCard" _hover={{ background: "dark.cardhover", cursor: "pointer", transform: "scale(1.02) translate(0, -5px)"}} transition="all .2s ease-in-out" boxShadow="2xl" noOfLines={1} minWidth="200px" width="auto" borderRadius={15} minHeight="350px" left="60px" position="relative">
