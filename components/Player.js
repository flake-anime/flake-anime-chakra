...
function Player({ width, height, episodeLink, trailerValid }){
    ...
    return (
        ...
        <Box position="relative" borderRadius={5} overflow="hidden" width={iframeWidth} height="562.5px">
            ...
            <iframe border="0" alignSelf="center" position="absolute" top="0px" bottom="0px" left="0px" right="0px" height="100%" width="100%" allowFullScreen src={"https://proxy-server-flake-anime.herokuapp.com/player?player_link=" + episodeLink}></iframe>
        </Box>
    )
}
