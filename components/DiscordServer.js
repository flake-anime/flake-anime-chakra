...
function DetailCard(){
    ...
    return (
        <Box onClick={join} cursor="pointer" zIndex={2} position="absolute" overflow="hidden" _hover={{  background: "dark.buttonhoverbackground" }} style={{ transition: "0.2s ease-in-out"}} top="95px" right="45px" bg="dark.buttonbackground" width="340px" height="150px" borderRadius="12px">
