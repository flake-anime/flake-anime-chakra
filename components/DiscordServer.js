...
function DetailCard() {
  ...
  return (
    <Box
      ...
      position="absolute"
      overflow="hidden"
      _hover={{ background: "dark.buttonhoverbackground" }}
      style={{ transition: "0.2s ease-in-out" }}
      top="95px"
      right="45px"
      bg="dark.buttonbackground"
      width="340px"
      height="150px"
      borderRadius="12px"
    ...
    >
      <Image
        ...
        marginLeft="20px"
        mixBlendMode="normal"
        fallbackSrc="https://i.imgur.com/8sJVxm8.jpg"
        borderRadius={25}
        boxShadow="2xl"
        width="110px"
        height="110px"
        src="https://i.pinimg.com/originals/fe/0b/65/fe0b65126ee24fcd2a2e84f20e9f8f42.jpg"
      ></Image>
      <Text
        fontSize="24"
        fontWeight="semibold"
      ...
      <Text
        ...
        paddingRight="10px"
      >
        Join our discord server for updates, events and be part of our
        community!
      </Text>
    </Box>
  );
