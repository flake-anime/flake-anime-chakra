...
function DetailCard(){
    ...
    return (
        <Box key="discord" onClick={join} cursor="pointer" zIndex={2} position="absolute" overflow="hidden" _hover={{  background: "dark.buttonhoverbackground" }} style={{ transition: "0.2s ease-in-out"}} top="95px" right="45px" bg="dark.buttonbackground" width="340px" height="150px" borderRadius="12px">
            <Image alt="Join Discord" zIndex={1} position="absolute" marginTop="20px" marginLeft="20px" mixBlendMode="normal" fallbackSrc="https://i.imgur.com/8sJVxm8.jpg" borderRadius={25} boxShadow="2xl" width="110px" height="110px" src="https://i.pinimg.com/originals/fe/0b/65/fe0b65126ee24fcd2a2e84f20e9f8f42.jpg"></Image>
