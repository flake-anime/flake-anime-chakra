...
function MyApp({ data }){
    ...
    return (
        <div>
            <Head>
                <title>Search Results for {searchedAnime}</title>
                <meta charSet="UTF-8"/>
            ...
            <SimpleGrid position="absolute" top="145px" style={{ height: "0vh", width: "100vw", display: "flex", flexWrap: "wrap" }} spacingX="15px">
