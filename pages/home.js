...
function MyApp(){
  return (
    <div>
        ...
        <Box>
            <IconButton aria-label="search" bgColor="white" color="#0194FF" height="44px" width="44px" top="35px" left="1375px" position="fixed" icon={<SearchIcon />} />
            ...
            <Input style={{ textTransform: "capitalize" }} placeholder="Search For An Anime..." _hover={{ bg:"#3b3f44" }} variant="filled" color="white" left="200px" bgColor="rgba(31, 34, 38)" height="44px" position="fixed" top="35px" width="350px"/>
            <IconButton aria-label="search" bgColor="#0194FF" color="white" height="44px" width="44px" top="35px" left="565px" position="fixed" icon={<SearchIcon />} />
        </Box>
        ...
        <Box>
            <SimpleGrid columns={5} spacingX="5px" spacingY="0px" position="absolute" top="400px" left="75px">
                {/* Attack On Titan */}
                <Box boxShadow="xl" borderRadius="15px" overflow="hidden" position="relative" top="200px">
                    <Image width="225px" maxW="225px" src="https://gogocdn.net/cover/shingeki-no-kyojin-the-final-season-part-2.png" position="relative"/>
                ...
                <Box boxShadow="xl" borderRadius="15px" overflow="hidden" position="relative" top="200px">
                    <Image width="225px" maxW="225px" src="https://gogocdn.net/cover/black-clover.png" position="relative"/>
                    <Box top="0px" width="225px" height="100%" borderRadius="15px" bgGradient="linear(to-b, rgba(17, 16, 21, 0) 0%, rgba(17, 16, 21, 0) 50%, rgba(17, 16, 21, 1) 90%)" position="absolute" />
                    <Box w="100%" background="#111015">
                    <Text paddingBottom="10px" fontSize="18" color="#C9C9C9" align="center" fontWeight="500" position="relative">Black Clover</Text>
                    </Box>
                </Box>

                <Box boxShadow="xl" borderRadius="15px" overflow="hidden" position="relative" top="200px">
                    <Image width="225px" height="90%" maxW="225px" src="https://gogocdn.net/cover/kimetsu-no-yaiba-dub.png" position="relative"/>
                    <Box top="0px" width="225px" height="100%" borderRadius="15px" bgGradient="linear(to-b, rgba(17, 16, 21, 0) 0%, rgba(17, 16, 21, 0) 50%, rgba(17, 16, 21, 1) 90%)" position="absolute" />
                    <Box w="100%" background="#111015">
                    <Text paddingBottom="10px" fontSize="18" color="#C9C9C9" align="center" fontWeight="500" position="relative">Demon Slayer</Text>
                    </Box>
                </Box> 
            </SimpleGrid>
        </Box>
