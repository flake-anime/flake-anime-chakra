...
function MyApp(){
  return (
    <Center marginTop="50px">
      ...
      <Box marginLeft="10px" boxShadow="xl" maxW="300px" borderRadius="15px" overflow="hidden">
        <Image width="225px" src="https://gogocdn.net/cover/shingeki-no-kyojin-the-final-season-part-2.png "/>
        <Box w="100%" background="#255073">
          <Text paddingBottom="10px" fontSize="18" color="#C9C9C9" align="center" fontWeight="500" >Shingeki no Kyojin</Text>
        </Box>
      </Box>
